from flex.core.db_initializer import DBInitializer
from models.test_operation.component import Building, Boiler, SpaceHeatingTank, HotWaterTank, SpaceCoolingTechnology, \
                                            PV, Battery, Vehicle, SEMS
from config import project_config


class ProjectDBInitializer(DBInitializer):
...
if __name__ == "__main__":
    initializer = ProjectDBInitializer(project_config)
    initializer.setup_project_database()
