...
class ProjectOperationInit(DatabaseInitializer):
    ...
    def setup_scenario_table(self):
        """
        The scenario table can be
        (1) generated by combining all possible component scenarios
        (2) pre-defined and loaded from the input_operation folder --> "OperationScenario.xlsx"
        """
