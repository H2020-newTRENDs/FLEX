...
class PhilippTestScenario(AbstractScenario):
    ...
    def add_component_with_params(self):
        ...
        # self.add_component_params(
        #     "boiler", GC(
        #         table.boiler, self.boiler_id
        #     ).get_params_dict()
        # )
        # self.add_component(
        ...
        # self.add_component(
        #     "air_conditioner", GC(
        #         table.air_conditioner, self.air_conditioner_id
        #     ).get_params_dict()
        # )
        # self.add_component(
        #     "hot_water_tank", GC(
        #         table.hot_water_tank, self.hot_water_tank_id
        #     ).get_params_dict()
        # )
        # self.add_component(
        #     "pv", GC(
        ...
        # self.add_component_params(
        #     "demand", GC(
        #         table.demand, self.demand_id
        #     ).get_params_dict()
        # )
        # self.add_component(
        #     "electricity_price", GC(
        #         table.electricity_price, self.electricity_price_id
        #     ).get_params_dict()
        # )
        # self.add_component(
        #     "feedin_tariff", GC(
        #         table.feedin_tariff, self.feedin_tariff_id
        #                         ).get_params_dict()
        # )
