...
class SongminTestScenario(AbstractScenario):
    ...
    def add_component_with_params(self):
        ...
        self.add_component("space_heating_tank", GC(table.space_heating_tank, self.space_heating_tank_id).get_params_dict())
        # self.add_component_params("air_conditioner", GC(table.air_conditioner, self.air_conditioner_id).get_params_dict())
        self.add_component("hot_water_tank", GC(table.hot_water_tank, self.hot_water_tank_id).get_params_dict())
