...
class OperationOptimization:
    ...
    def run_Optimization(self, household_id, environment_id):
        ...
        m.Q_TankHeating = pyo.Var(m.t, within=pyo.NonNegativeReals, bounds=(0, 11_000))
        m.Q_HeatingElement = pyo.Var(m.t, within=pyo.NonNegativeReals, bounds=(0, 6_000))
        ...
        def tank_energy(m, t):
            if t == 1:
                ...
                return m.E_tank[t] == m.E_tank[t - 1] - m.Q_RoomHeating[t] + m.Q_TankHeating[t]* 1 \
...
def show_results(instance, M_WaterTank, CWater, colors):
    ...
    # fig, ax1 = plt.subplots()
    # ax1.plot(x_achse, BatCharge, label='BatCharge', color='green', alpha=0.6)
