...
class Config(ABC):
    def __init__(self, project_name: str):
        ...
        self.fig: "Path" = self.setup_path(f"data/figure/")
        self.config_logging()

    def setup_path(self, folder_path: str) -> "Path":
        folder_path = os.path.join(os.path.dirname(folder_path), self.project_name)
