...
from flex.data import source_data_types
...
class DB:
    ...
    def __init__(self, config: 'Config'):
        self.config = config
        self.folder_path = config.db_folder
        self.connection = self.create_connection(config.db_name)
    ...
    def read_dataframe_old(self, table_name: str, *column_names: list, **kwargs: dict) -> pd.DataFrame:
